<div align="center">
  <img src="./assets/Logo.jpeg" alt="Logo" height="200">
  <h2>
    Crime Rate Analysis 🚨
  </h2>
</div>
...
<details>
<summary>📈 Advanced Plotting</summary>
<br>

<div align="center">

<p style="font-family: 'Georgia', serif; font-size: 18px;">
Dynamic visualizations using Plotly for temporal and spatial analysis. Includes customizable and interactive charts.
</p>

1. **Crime Time Series**  
![image](./assets/plotting1.png)

2. **Category Distribution (Sunburst)**  
![image](./assets/plotting2.png)

3. **Variable Correlation**  
![image](./assets/plotting3.png)

</div>
</details>

<details>
<summary>📊 Statistical Charts</summary>
<br>

<div align="center">

<p style="font-family: 'Georgia', serif; font-size: 18px;">
Dashboard with bar charts, temporal heatmaps, and crime distribution by weekday or category.
</p>
...
![image](./assets/grafico2.png)

3. **Hourly Heatmap**  
![image](./assets/grafico3.png)
...
<table class="team-table">
    ...
    <tr>
        <td><img src="https://via.placeholder.com/80" class="team-photo"></td>
        <td>Miguel</td>
        <td>Charts Implementation</td>
    </tr>
    <tr>
        <td><img src="https://via.placeholder.com/80" class="team-photo"></td>
        <td>Angel Ortega</td>
        <td>Project Deployment & Map</td>
    </tr>
    <tr>
        <td><img src="https://via.placeholder.com/80" class="team-photo"></td>
        <td>Andres Aviles</td>
        <td>Plotting Diagram</td>
    </tr>
</table>
...
```bash
git clone https://github.com/your_username/proyecto_crimen.git
